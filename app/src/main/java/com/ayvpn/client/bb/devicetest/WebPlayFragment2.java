...
public class WebPlayFragment2 extends Activity  {
...
//    private SwipeRefreshLayout mSwipeRefreshLayout;
    ...
    private static class LocalHandler extends Handler {
        private WeakReference<WebPlayFragment2> mContext;

        public LocalHandler(WebPlayFragment2 context) {
            this.mContext = new WeakReference<WebPlayFragment2>(context);
        }

        @Override
        public void handleMessage(Message msg) {
            WebPlayFragment2 context = mContext.get();
            if (context != null) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_webpaly2);
