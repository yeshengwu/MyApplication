...
public class Reduction {
    ...
    private static final Function<String> STRING = new Function<String>() {
    ...
    public static void main(String[] args) {
        ...
        List<String> strList = Arrays.asList("a","b"); //evan add
        ...
        System.out.println(reduce(strList, STRING, "init"));
    }
}